...
string sqlInsertStringMaker(const cma_frame& frm)
{
    ...
    string ret("insert into sd_fbjc (CDID, AcquisitionTime, Tension, Windage_Yaw_Angle, Deflection_Angle, Battery_Voltage, Operation_Temperature, Line_Temperature1, Line_Temperature2) VALUES");
