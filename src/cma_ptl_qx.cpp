...
map<string,string> frameParserFunc(cma_frame& frm)
{
		...
		uint32_t average_WindSpeed_10min = makelong(makeword(data[23], data[24]), makeword(data[25], data[26]));
		uint16_t average_WindDirection_10min = makeword(data[27], data[28]);
		uint32_t max_WindSpeed = makelong(makeword(data[29], data[30]), makeword(data[31], data[32]));
		uint32_t extreme_WindSpeed = makelong(makeword(data[33], data[34]), makeword(data[35], data[36]));
		uint32_t standard_WindSpeed = makelong(makeword(data[37], data[38]), makeword(data[39], data[40]));
		uint32_t air_Temperature = makelong(makeword(data[41], data[42]), makeword(data[43], data[44]));
		uint16_t humidity = makeword(data[45], data[46]);
		uint32_t air_Pressure= makelong(makeword(data[47], data[48]), makeword(data[49], data[50]));
		uint32_t precipitation= makelong(makeword(data[51], data[52]), makeword(data[53], data[54]));
		uint32_t precipitation_Intensity= makelong(makeword(data[55], data[56]), makeword(data[57], data[58]));
