...
map<string,string> frameParserFunc(cma_frame& frm)
{
	...
	uint32_t line_Temperature1 = makelong(makeword(data[23], data[24]), makeword(data[25], data[26]));
	uint32_t line_Temperature2 = makelong(makeword(data[27], data[28]), makeword(data[29], data[30]));
